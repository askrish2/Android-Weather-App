...
import com.teamtreehouse.stormy.Hour;
import com.teamtreehouse.stormy.R;

/**
 * Created by ashkrishnan on 7/4/16.
 */
public class HourAdapter extends RecyclerView.Adapter<HourAdapter.HourViewHolder> {
    ...
    public class HourViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public HourViewHolder(View itemView) {
            ...
            mSummaryLabel = (TextView) itemView.findViewById(R.id.summLabel);
        ...
        public void bindHour(Hour hour) {
            ...
            mSummaryLabel.setText(hour.getSum());
        ...
        public void onClick(View v) {
            ...
            String sum = mSummaryLabel.getText().toString();
            String message = String.format("At %s it will be %s and %s", time, temp, sum);
